...
#include "common/drivers/sensor_bases/GyroscopeBase.h"
...
void test_gyro_base_constructor() {
    MockGyroBase sensor;
...
void test_all_gyro_base() {

    RUN_TEST(test_gyro_base_constructor);
    RUN_TEST(test_gyro_base_read);
